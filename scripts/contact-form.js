...
const fullName = document.getElementById('full-name-wrapper').children;
const email = document.getElementById('email-wrapper').children;
const subject = document.getElementById('subject-wrapper').children;
    ...
    if (
        ...
        fetch(form.action, {
          ...
          .then((response) => {
           ...
           // alert('Form submitted successfully!'); - Instead Build Pop-up modal / overlay for success confirmation !
